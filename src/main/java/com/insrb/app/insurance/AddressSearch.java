...
public class AddressSearch {
    ...
    public Map<String, Object> getHouseCoverInfo(String sigunguCd, String bjdongCd, int bun, int ji) {
        ...
        HttpResponse<String> res =
                Unirest.get("http://apis.data.go.kr/1611000/BldRgstService/getBrTitleInfo")
                        ...
                        .queryString("sigunguCd", sigunguCd).queryString("bjdongCd", bjdongCd)
                        .queryString("bun", str_bun).queryString("ji", str_ji)
                        .queryString("numOfRows", "1000").queryString("pageNo", "1").asString();
     ...
     * @return  Map<String,Object>
     */
    public Map<String, Object> getHouseDetailInfo(String sigunguCd, String bjdongCd, int bun, int ji) {
        String str_bun = String.format("%04d", bun);
        String str_ji = String.format("%04d", ji);

        HttpResponse<String> res =
                Unirest.get("http://apis.data.go.kr/1611000/BldRgstService/getBrExposPubuseAreaInfo")
                        .queryString("ServiceKey", APIS_DATA_GO_KR_SERVICE_KEY)
                        .queryString("sigunguCd", sigunguCd).queryString("bjdongCd", bjdongCd)
                        .queryString("bun", str_bun).queryString("ji", str_ji)
                        .queryString("numOfRows", "1000").queryString("pageNo", "1").asString();
