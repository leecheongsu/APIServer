...
public class AddressSearch {
   ...
   *
   */
  private static final String JUSO_GO_KR_URL =
    "http://www.juso.go.kr/addrlink/addrLinkApi.do";
  private static final String CONFIRM_KEY =
    "U01TX0FVVEgyMDIwMDcwODE3MDExMTEwOTkzNzM=";
   ...
   */
  public Map<String, Object> getHouseCoverInfo(
    String sigunguCd,
    String bjdongCd,
    int bun,
    int ji
   ...
   * @return  Map<String,Object>
   */
  public Map<String, Object> getHouseDetailInfo(
    String sigunguCd,
    String bjdongCd,
    int bun,
    int ji
    ...
    HttpResponse<String> res = Unirest
      .get(
        "http://apis.data.go.kr/1611000/BldRgstService/getBrExposPubuseAreaInfo"
      )
      .queryString("ServiceKey", APIS_DATA_GO_KR_SERVICE_KEY)
      .queryString("sigunguCd", sigunguCd)
      .queryString("bjdongCd", bjdongCd)
