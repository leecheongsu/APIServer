...
public class HiConfig {
	...
	public static String WW_CLIENT_ID = "53dca6a6";
	public static String WW_CLIENT_SECRET = "5a838fc51a4015d030f19770f78fc143";
	public static String COMMON_CLIENT_ID = "60b111e8";
	public static String COMMON_CLIENT_SECRET = "9241b101f32b482853a8ea40c7ec8ba2";

    // Request header
    public static String X_Channel_Id = "Main";
    public static String X_Client_Id = "210.179.172.177";
    public static String X_Menu_Id = "home";
    public static String X_User_Id = "4IB078";
