...
public class UsersControllerTest {
    ...
    public void UIAPP004_01() throws Exception {
        mockMvc.perform(post("/users")).andDo(print()).andExpect(status().isBadRequest());
    }

    @Test
    @DisplayName("UI-APP-004 회원가입: POST /users 전화번호가 숫자가 아니면 400 BAD_REQUEST를 리턴해야한다")
    public void UIAPP004_02() throws Exception {
        mockMvc.perform(post("/users").param("email", mockUser.get("email"))
                .param("name", mockUser.get("name")).param("teltype", mockUser.get("teltype"))
                .param("mobile", mockUser.get("mobile") + "xxxx").param("pwd", mockUser.get("pwd"))
                .param("jumina", mockUser.get("jumina")).param("sex", mockUser.get("sex")))
    ...
    public void UIAPP004_03() throws Exception {
        mockMvc.perform(post("/users").param("email", mockUser.get("email"))
                .param("name", mockUser.get("name")).param("teltype", mockUser.get("teltype"))
                .param("mobile", mockUser.get("mobile")).param("pwd", mockUser.get("pwd"))
                .param("jumina", mockUser.get("jumina") + "xxxx").param("sex", mockUser.get("sex")))
                .andDo(print()).andExpect(status().isBadRequest());
    }
    ...
    public void UIAPP004_05() throws Exception {
        mockMvc.perform(post("/users/business").param("email", mockGAUser.get("email"))
                .param("name", mockGAUser.get("name")).param("teltype", mockGAUser.get("teltype"))
                .param("mobile", mockGAUser.get("mobile")).param("pwd", mockGAUser.get("pwd"))
                .param("jumina", mockGAUser.get("jumina")).param("sex", mockGAUser.get("sex"))
                .param("comname", mockGAUser.get("comname")).param("sosok", mockGAUser.get("sosok"))
                .param("businessnum", mockGAUser.get("businessnum"))).andDo(print())
    ...
    public void UIAPP005_01() throws Exception {
        mockMvc.perform(get("/users/" + mockUser.get("email") + "/isjoined")).andDo(print())
                .andExpect(status().isOk())
    ...
    public void UIAPP005_02() throws Exception {
        mockMvc.perform(get("/users/" + badUser + "/isjoined")).andDo(print())
    ...
    public void UIAPP005_03() throws Exception {
        mockMvc.perform(put("/users/" + mockUser.get("email") + "/juminb").header(
                Authentication.HEADER_STRING,
                Authentication.GetAuthorizationValue(mockUser.get("email")))).andDo(print())
                .andExpect(status().isBadRequest());
    }

    @Test
    @DisplayName("UI-APP-005 주민번호뒷자리 Update: PUT /users/{user_id}/juminb Header에 bearer 토큰이 없으면 401 UNAUTHORIZED 오류를 발생한다")
    public void UIAPP005_04() throws Exception {
        mockMvc.perform(put("/users/" + mockUser.get("email") + "/juminb").param("juminb",
                mockUser.get("juminb"))).andDo(print()).andExpect(status().isUnauthorized());
    }
    ...
    public void UIAPP005_05() throws Exception {
        mockMvc.perform(put("/users/" + mockUser.get("email") + "/juminb")
                .header(Authentication.HEADER_STRING,
                        Authentication.GetAuthorizationValue(mockUser.get("email")))
                .param("pwd", mockUser.get("pwd")).param("juminb", mockUser.get("juminb") + "AAA"))
                .andDo(print()).andExpect(status().isBadRequest());
    }
    ...
    public void UIAPP005_06() throws Exception {
        mockMvc.perform(put("/users/" + mockUser.get("email") + "/juminb")
                .header(Authentication.HEADER_STRING,
                        Authentication.GetAuthorizationValue(mockUser.get("email")))
                .param("juminb", mockUser.get("juminb"))).andDo(print()).andExpect(status().isOk());
    }
    ...
    public void UIAPP008_01() throws Exception {
        mockMvc.perform(post("/users/auth")).andDo(print()).andExpect(status().isBadRequest());
    }

    @Test
    @DisplayName("UI-APP-008 로그인: POST /users/auth 패스워드가 틀리면 401 UNAUTHORIZED를 리턴해야한다")
    public void UIAPP008_02() throws Exception {
        mockMvc.perform(post("/users/auth").param("id", mockUser.get("email")).param("pwd",
                "invalidPassword")).andDo(print()).andExpect(status().isUnauthorized());
    }
    ...
    public void UIAPP008_03() throws Exception {
        mockMvc.perform(post("/users/auth").param("id", mockUser.get("email")).param("pwd",
                mockUser.get("pwd"))).andDo(print()).andExpect(status().isOk())
    ...
    public void UIAPP009_01() throws Exception {
        mockMvc.perform(get("/users/email")).andDo(print()).andExpect(status().isBadRequest());
    }
    ...
    public void UIAPP009_02() throws Exception {
        mockMvc.perform(get("/users/email").param("name", mockUser.get("name"))
                .param("teltype", mockUser.get("bad_teltype"))
                .param("mobile", mockUser.get("mobile")).param("jumina", mockUser.get("jumina"))
                .param("sex", mockUser.get("sex"))).andDo(print()).andExpect(status().isNotFound());
    }
    ...
    public void UIAPP009_03() throws Exception {
        mockMvc.perform(get("/users/email").param("name", mockUser.get("name"))
                .param("teltype", mockUser.get("teltype")).param("mobile", mockUser.get("mobile"))
                .param("jumina", mockUser.get("jumina")).param("sex", mockUser.get("sex")))
                .andDo(print()).andExpect(status().isOk())
                .andExpect(content().string(containsString(mockUser.get("email"))));
    }
    ...
    public void UIAPP011_01() throws Exception {
        mockMvc.perform(get("/users/" + mockUser.get("email") + "/can-change")).andDo(print())
                .andExpect(status().isBadRequest());
    }
    ...
    public void UIAPP011_02() throws Exception {
        mockMvc.perform(get("/users/" + mockUser.get("email") + "/can-change")
                .param("teltype", mockUser.get("bad_teltype"))
                .param("mobile", mockUser.get("mobile"))).andDo(print())
                .andExpect(status().isNotFound());
    }
    ...
    public void UIAPP012_01() throws Exception {
        mockMvc.perform(put("/users/" + mockUser.get("email") + "/pwd")).andDo(print())
                .andExpect(status().isBadRequest());
    }

    @Test
    @DisplayName("UI-APP-012 비밀번호 찾기(비밀번호 변경): PUT /users/{user_id}/pwd 파라미터값이 하나라도 틀리면 404 NOT_FOUND를 리턴해야한다")
    public void UIAPP012_02() throws Exception {
        mockMvc.perform(put("/users/" + mockUser.get("email") + "/pwd")
                .param("teltype", mockUser.get("bad_teltype"))
                .param("mobile", mockUser.get("mobile")).param("newPwd", mockUser.get("newPwd")))
                .andDo(print()).andExpect(status().isNotFound());
    }

    @Test
    @DisplayName("UI-APP-012 비밀번호 찾기(비밀번호 변경): PUT /users/{user_id}/pwd 올바른 정보를 제공하면 패스워드를 변경하고 OK를 리턴해야한다")
    public void UIAPP012_03() throws Exception {
        mockMvc.perform(put("/users/" + mockUser.get("email") + "/pwd")
                .param("teltype", mockUser.get("teltype")).param("mobile", mockUser.get("mobile"))
                .param("newPwd", mockUser.get("newPwd"))).andDo(print()).andExpect(status().isOk());
    }

    @Test
    @DisplayName("UI-APP-014 회원정보변경(기본정보): PUT /users/{user_id}/basic Header에 bearer 토큰이 없으면 401 UNAUTHORIZED 오류를 발생한다")
    public void UIAPP014_01() throws Exception {
        mockMvc.perform(put("/users/" + mockUser.get("email") + "/basic")
                // .header(Authentication.HEADER_STRING,Authentication.GetAuthorizationValue(mockUser.get("email")))
                .param("pwd", mockUser.get("bad_pwd")).param("name", mockUser.get("name"))
                .param("teltype", mockUser.get("teltype")).param("mobile", mockUser.get("mobile"))
                .param("jumina", mockUser.get("jumina")).param("sex", mockUser.get("sex")))
    ...
    public void UIAPP014_02() throws Exception {
        mockMvc.perform(put("/users/" + mockUser.get("email") + "/basic").header(
                Authentication.HEADER_STRING,
                Authentication.GetAuthorizationValue(mockUser.get("email")))).andDo(print())
                .andExpect(status().isBadRequest());
    }
    ...
    public void UIAPP014_03() throws Exception {
        mockMvc.perform(put("/users/" + mockUser.get("email") + "/basic")
                ...
                .param("jumina", mockUser.get("jumina") + "xxx").param("sex", mockUser.get("sex")))
                .andDo(print()).andExpect(status().isBadRequest());
    }

    @Test
    @DisplayName("UI-APP-014 회원정보변경(기본정보): PUT /users/{user_id}/basic 올바른 정보를 제공하면 basic정보를 변경하고 OK를 리턴해야한다")
    public void UIAPP014_04() throws Exception {
        mockMvc.perform(put("/users/" + mockUser.get("email") + "/basic")
                ...
                .param("name", mockUser.get("name")).param("teltype", mockUser.get("teltype"))
                .param("mobile", mockUser.get("mobile")).param("jumina", mockUser.get("jumina"))
                .param("sex", mockUser.get("sex"))).andDo(print()).andExpect(status().isOk());
    }

    @Test
    @DisplayName("UI-APP-016 회원정보변경(사업자정보): PUT /users/{user_id}/business Header에 bearer 토큰이 없으면 401 UNAUTHORIZED 오류를 발생한다")
    public void UIAPP016_01() throws Exception {
        mockMvc.perform(put("/users/" + mockGAUser.get("email") + "/business")
                // .header(Authentication.HEADER_STRING,Authentication.GetAuthorizationValue(mockUser.get("email")))
                .param("comname", mockGAUser.get("comname")).param("sosok", mockGAUser.get("sosok"))
                .param("businessnum", mockGAUser.get("businessnum"))).andDo(print())
    ...
    public void UIAPP016_02() throws Exception {
        mockMvc.perform(put("/users/" + mockGAUser.get("email") + "/business").header(
                Authentication.HEADER_STRING,
                Authentication.GetAuthorizationValue(mockGAUser.get("email")))).andDo(print())
                .andExpect(status().isBadRequest());
    }
    ...
    public void UIAPP016_03() throws Exception {
        mockMvc.perform(put("/users/" + mockGAUser.get("email") + "/business")
                .header(Authentication.HEADER_STRING,
                        Authentication.GetAuthorizationValue(mockGAUser.get("email")))
                .param("comname", mockGAUser.get("comname")).param("sosok", mockGAUser.get("sosok"))
                .param("businessnum", mockGAUser.get("businessnum") + "xxx")).andDo(print())
                .andExpect(status().isBadRequest());
    }

    @Test
    @DisplayName("UI-APP-016 회원정보변경(사업자정보): PUT /users/{user_id}/business 올바른 정보를 제공하면 ga_detail정보를 변경하고 OK를 리턴해야한다")
